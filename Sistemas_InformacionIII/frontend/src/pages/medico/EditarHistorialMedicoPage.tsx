        ...
        {historial && (
          <div style={{
            ...
            <p style={{ color: "white", margin: '4px 0 0 0', fontSize: 14 }}>
              <strong>Paciente:</strong> {historial.turno?.paciente?.usuario?.nombreUsuario ?? "Sin datos"}
            </p>
            <p style={{ color: "white", margin: '4px 0 0 0', fontSize: 14 }}>
              <strong>Fecha:</strong> {historial.turno?.fecha
                ? new Date(historial.turno.fecha).toLocaleDateString('es-ES')
                : "No disponible"}
            </p>
          </div>
        )}
